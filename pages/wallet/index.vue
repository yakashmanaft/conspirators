...
<template>
  <Container style="margin-top: 5rem">
    ...
    <div style="display: flex; justify-content: space-between;">
      ...
      <div style="background-color: gray; min-width: 33%;"v-for="section in wallet_sections">

        <!-- section header -->
        <div>
          <h2 style="font-size: unset; font-weight: unset;">{{ section.title }}</h2>
          <p style="font-size: 48px; font-weight: bold;">{{ section.total }} P</p>
        </div>
        ...
        <div>
          ...
          <div>
            ...
            <h3 style="font-size: unset; font-weight: unset;">2704Кредит2024</h3>
            <p>275 734.00</p>
          </div>

          <div>

            <h3 style="font-size: unset; font-weight: unset;">Брокерский счет (Тинькофф)</h3>
            <p>275 734.00</p>
          </div>
        </div>
      </div>
